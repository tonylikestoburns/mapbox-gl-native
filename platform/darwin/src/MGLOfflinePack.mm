...
- (id <MGLOfflineRegion>)region {
    ...
    NSAssert([MGLGeometryOfflineRegion conformsToProtocol:@protocol(MGLOfflineRegion_Private)], @"MGLGeometryOfflineRegion should conform to MGLOfflineRegion_Private.");
    ...
    return regionDefinition.match(
                           ...
                           [&] (const mbgl::OfflineGeometryRegionDefinition& def){
                               return (id <MGLOfflineRegion>)[[MGLGeometryOfflineRegion alloc] initWithOfflineRegionDefinition:def];
                           });
}
