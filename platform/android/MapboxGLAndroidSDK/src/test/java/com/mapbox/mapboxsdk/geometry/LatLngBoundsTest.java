...
public class LatLngBoundsTest {
  ...
  public void unionEastWrapCheck() {
    ...
    assertEquals(unionLatLngBounds, LatLngBounds.from(90, -160, 0, 0));
  }
  ...
  public void unionWestWrapCheck() {
    ...
    assertEquals(unionLatLngBounds, LatLngBounds.from(0, 0, -90, 160));
  }
  ...
  public void intersectEastWrapCheck() {
    LatLngBounds intersectLatLngBounds =
      LatLngBounds.from(10, -150, 0, 0)
        .intersect(90, 200, 0, 0);

    assertEquals(intersectLatLngBounds, LatLngBounds.from(10, -160, 0, 0));
  }

  @Test
  public void intersectWestWrapCheck() {
    LatLngBounds intersectLatLngBounds =
      LatLngBounds.from(0, 0, -10, 150)
        .intersect(0, 0, -90, -200);

    assertEquals(intersectLatLngBounds, LatLngBounds.from(0, 0, -10, 160));
  }
