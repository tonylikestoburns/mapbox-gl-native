...
TEST(SymbolProgram, SymbolSizeBinder) {
    ...
    binder = SymbolSizeBinder::create(1.0f, style::CameraFunction<float>(expression::Convert::toExpression(style::ExponentialStops<float>({
        {0.0f, 8.0f},
        {10.0f, 18.0f}
    }, 1.0f))), 0.0f);
    ...
    binder = SymbolSizeBinder::create(0.0f, style::CameraFunction<float>(expression::Convert::toExpression(style::ExponentialStops<float>({
        {1.0f, 8.0f},
        {11.0f, 18.0f}
    }, 1.0f))), 0.0f);
    ...
    binder = SymbolSizeBinder::create(12.0f, style::CameraFunction<float>(expression::Convert::toExpression(style::ExponentialStops<float>({
        {1.0f, 8.0f},
        {11.0f, 18.0f}
    }, 1.0f))), 0.0f);
    ...
    binder = SymbolSizeBinder::create(0.0f, style::SourceFunction<float>(expression::Convert::toExpression("x", style::ExponentialStops<float>({
        {1.0f, 8.0f},
        {11.0f, 18.0f}
    }, 1.0f))), 0.0f);
    uniformValues = binder->uniformValues(12.5f);
    ...
    binder = SymbolSizeBinder::create(5.0f, style::CompositeFunction<float>(expression::Convert::toExpression("x", style::CompositeExponentialStops<float>({
