...
TEST(CompositeFunction, ZoomInterpolation) {
    EXPECT_EQ(40.0f, CompositeFunction<float>(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
    ...
    EXPECT_EQ(33.0, CompositeFunction<float>(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
    ...
    EXPECT_EQ(66.0, CompositeFunction<float>(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
        {0.0f, {{uint64_t(1), 33.0f}}},
        {10.0f, {{uint64_t(1), 66.0f}}}
    })), 0.0f)
    .evaluate(20.0f, oneInteger, -1.0f)) << "Use last stop output for input values from last stop to +inf";

    EXPECT_EQ(66.0f, CompositeFunction<float>(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
        {0.0f, {{uint64_t(1), 33.0f}}},
        {10.0f, {{uint64_t(1), 66.0f}}}
    })), 0.0f)
    .evaluate(10.0f, oneInteger, -1.0f)) << "Should interpolate TO the last stop.";
    
    EXPECT_EQ(33.0f, CompositeFunction<float>(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
        {0.0f, {{uint64_t(1), 33.0f}}},
        {10.0f, {{uint64_t(1), 66.0f}}}
    })), 0.0f)
...
TEST(CompositeFunction, Issue8460) {
    CompositeFunction<float> fn1(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
    ...
    CompositeFunction<float> fn2(expression::Convert::toExpression("property", CompositeExponentialStops<float>({
        {15.0f, {{uint64_t(1), 0.0f}}},
